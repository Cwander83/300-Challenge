  ...
  return (
    <div className="homeDiv">
      <Jumbotron className="jumboHome">
        <ScrollAnimation className="homeH1"animateIn='fadeIn' delay={50} animateOut='fadeOut'>
          <h1>
            THIS IS THE
          </h1>

        </ScrollAnimation>
        <ScrollAnimation className="homeH1"delay={50} animateIn='bounceInLeft' animateOut='bounceOutLeft'>
          <h1>
            300 CHALLENGE
          ...
          <div className="homeDesc">
            <h2 className="homeH2">
              Now you're all signed in lets start to go over why you're here!
                ...
                <p>This is the original workout used the the cast of the movie <strong>300</strong>,
                  created by fitness trainer <strong>Mark Twight</strong>. 
                  It is an intense training system and is not meant to be
                  performed every day. The 300 Spartan workout is best approached like a fullbody
                  training system, using it 3 times per week on alternating days.</p>
                <ul>
                  <li>
                ...
                <p>
                  ...
                  not be attempted by beginners. Make sure you take time to learn <em>proper</em> deadlift
                  form and build up your overall conditioning before attempting the 300 Spartan
                  workout. Jumping into any intense workout system without a solid level of
                  conditioning and exercise form puts you at risk for injury.</p>
                <p>
                ...
                <p>
                  ...
                  <p>This Info was collected from Muscle and Strength.com <a href="https://www.muscleandstrength.com/workouts/300-spartan-workout">here for full story</a></p>
